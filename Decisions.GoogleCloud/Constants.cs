...
{
    public const string STEP_CATEGORY = "Integration/Google Cloud";
    public const string STEP_CATEGORY_BIGQUERY = "Integration/Google Cloud/BigQuery";
    public const string STEP_CATEGORY_TRANSLATION = "Integration/Google Cloud/Translation";
